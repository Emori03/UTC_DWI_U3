...
if (isset($_POST['submit'])) {
    ...
    if ($user && password_verify($secret_answer, $user['secret_answer'])) {
        ...
        $error = "Correo electrónico o respuesta secreta incorrectos.";
    }
}
?>
...
<div class="container">
  ...
  <form action="" method="post">
    ...
    <div class="form-group">
      <label for="secret_answer">Respuesta Secreta:</label>
      <input type="text" id="secret_answer" name="secret_answer" class="form-control" required>
    </div>
    <button type="submit" name="submit" class="btn btn-dark btn-outline-light">Enviar</button>
  </form>
</div>
</body>
</html>
